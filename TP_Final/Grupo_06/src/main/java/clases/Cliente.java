 ...
 * @author gc
 * <br>
 * Clase que extiende de Usuario que representa a un cliente de la plataforma dentro del sistema. Contiene nombre, nombreReal y contraseña. Tiene la capacidad de generar Pedido
 */
public class Cliente extends Usuario {

    /**
     * Constructor con tres parametros para setear el nombre, nombreReal y contraseña de un nuevo Cliente. <br>
     *
     ...
     *
     * @param fecha: parametro de tipo LocalTimeDate que representa la fecha en la cual se realizó el pedido. <br>
     * @param zona: parametro de tipo String que representa la zona en la cual se realizará el viaje. Existen tres tipos: Estandar, Calle sin asfaltar y Zona peligrosa. <br>
     ...
     * @param distancia: parametro de tipo int que representa la distancia en km. que tomará realizar el viaje. <br>
