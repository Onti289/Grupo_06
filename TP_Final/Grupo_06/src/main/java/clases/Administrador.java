 ...
 * @author gc
 * <br>
 * Clase que extiende de Usuario que representa a los administradores dentro del sistema. Contiene nombre, nombreReal, contraseña, colaChofer, colaVehiculos y listaCliente. <br>
 ...
 * ombreReal, contraseña, colaChofer, colaVehiculos y listaCliente. <br>
...
public class Administrador extends Usuario{
    private LinkedList<Chofer> colaChofer;
    private LinkedList<Vehiculo> colaVehiculos;
    private LinkedList<Cliente> listaCliente;

    /**
     * Constructor con tres parametros para setear el nombre, nombreReal y contraseña de un nuevo Administrador. <br>
     *
     ...
     * Se instancian los parametros colaChofer, colaVehiculos y listaCliente. <br>
     *
     */
    public Administrador(String nombre, String contrasena, String nombreReal) {
            super(nombre,contrasena,nombreReal);
            this.colaChofer = new LinkedList<Chofer>();
            this.colaVehiculos = new LinkedList<Vehiculo>();
            this.listaCliente = new LinkedList<Cliente>();
    }
     ...
     *
     * @param chofer: parametro de tipo Chofer que recibe el chofer el cual se le aplicarán las modificaciones <br>
    ...
    public void ModificaChofer(Chofer c) throws ChoferNoEncontradoException {
        ...
        while (!encontrado && i < colaChofer.size()) {
            Chofer aux = colaChofer.get(i);
            if (aux.equals(c)) {
                colaChofer.set(i, c);
                encontrado = true;
            }
	 ...
	 *
	 * @param v: parametro de tipo Vehiculo que recibe el vehiculo al cual se le aplicará la modificacion. <br>
     ...
     *
	 * @param cliente: parametro de tipo Cliente que contiene el cliente al cual se le aplicarán las modificaciones. <br>
	 * @param nombre: parametro de tipo String que contiene el nombre de usuario actualizado del cliente. <br>
	 * @param contrasena: parametro de tipo String que contiene la contraseña actualizada del cliente. <br>
	...
	public boolean existeCliente(Cliente c) {
		return this.listaCliente.contains(c);
	}
	...
	public boolean isChoferDisponible() {
		return !this.colaChofer.isEmpty();
	}
	...
	public void calculoPuntosMes()
	{
		...
		int j=-1;
		  ...
		  for (int i=0; i < this.colaChofer.size() ; i++)
		  {
			  c = this.colaChofer.get(i);
		  ...
		  if (j != -1)
			  this.colaChofer.get(j).setPuntos(15);
	}
